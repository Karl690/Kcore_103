...
/*----------Stack Configuration-----------------------------------------------*/  
#define STACK_SIZE       0x00000800	//GB XXX was: 0x00000100      /*!< The Stack size suggest using even number     */
...
#include "main.h"
//extern void safelyShutdownAndReset(void);
//#define FULL_SHUTDOWN_TIME xxxx
static void Default_Handler(void) 
{
	safelyShutdownAndReset(FULL_SHUTDOWN_TIME, 99, 99);
}
