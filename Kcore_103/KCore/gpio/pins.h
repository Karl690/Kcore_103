...
GPIO_TypeDef *pinExtractPortPtr(pinType);
void pinInit(pinType);
void pinClear(pinType);
void pinSet(pinType);
void pinWrite(pinType, uint32_t);
uint32_t pinRead(pinType);
uint32_t pinReadOutput(pinType);
void pinToggleOutput(pinType);
