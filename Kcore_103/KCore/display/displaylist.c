...
LcdVariableInfo LcdVarsTable[] = {	
	{ &HeartBeat, HEARTBEATSTRING,		FUNC_INT32, RED, MAGENTA, 0, VariableDisplayStart,			 5, 1 },
	{ &ADC_Channel[1].adcAvg, "VOLTS",	FUNC_TITLE, WHITE, MAGENTA, 0, VariableDisplayStart - 40,	15, 2 },
	{ &UvataVoltage,			   "",  FUNC_FLOAT, WHITE, MAGENTA, 0, VariableDisplayStart - 40,	35, 2 },
	{ &ADC_Channel[1].adcAvg, "DUTY",	FUNC_TITLE, WHITE, MAGENTA, 0, VariableDisplayStart - 40,		60, 2 },
	{ &UvataDuty, "",					FUNC_INT16, WHITE, MAGENTA, 0, VariableDisplayStart - 40, 80, 2 },
	{ &CurrentSetPoint, "ISET",			FUNC_FLOAT, WHITE, MAGENTA, 0, VariableDisplayStart, 100, 1 },
	{ &laserTemperature, "Temp",		FUNC_FLOAT, WHITE, MAGENTA, 0, VariableDisplayStart, 110, 1 },
	{ (uint32_t)0, "--------", FUNC_INT32, WHITE, MAGENTA, 0, VariableDisplayStart - 40, 120,1 },
};
