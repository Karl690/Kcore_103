...
const AdcTableStruct HeadPositionTable[] __attribute__((aligned(4))) =
...
const AdcTableStruct RtdTable_50K[] __attribute__((aligned(4))) =
{
...
const AdcTableStruct RtdTable_1K[] __attribute__((aligned(4))) =
...
const AdcTableStruct RtdTable_100[] __attribute__((aligned(4))) =
{
