...
#define ST7735_DC_PIN      GPIO_PIN_14    // PB14
...
#define ST7735_CS_PIN      GPIO_PIN_12    // PB12

// CS pin macros
#define CS_L() SPI_GPIO_PORT->BRR	= ST7735_CS_PIN
#define CS_H() SPI_GPIO_PORT->BSRR 	= ST7735_CS_PIN

// A0 pin macros
#define DC_L() SPI_GPIO_PORT->BRR	= ST7735_DC_PIN
#define DC_H() SPI_GPIO_PORT->BSRR	= ST7735_DC_PIN

// RESET pin macros
#define RST_L() SPI_GPIO_PORT->BRR= ST7735_RST_PIN
#define RST_H() SPI_GPIO_PORT->BSRR	= ST7735_RST_PIN
